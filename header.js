...
// ASCII Art Header for AGENT-E - Agent Everything
const AGENTE_ASCII = `
    ╔═════════════════════════════════════════════════════════════════════╗
    ║                                                                     ║
    ║   █████╗   ██████╗  ███████╗ ███╗   ██╗ ████████╗       ███████╗    ║
            ...
            {showSystemInfo && (
                <Box flexDirection="column" alignItems="center" marginTop={1}>
                    <Text color="#ffaa00" bold>
                        🚀 AGENT-E v{SYSTEM_INFO.version} ({SYSTEM_INFO.build})
                    </Text>
                    <Text color="#888888">
...
const SimpleHeader = () => {
    ...
    console.log('\x1b[38;5;208m\x1b[1m🚀 AGENT-E v' + SYSTEM_INFO.version + ' (' + SYSTEM_INFO.build + ')\x1b[0m');
